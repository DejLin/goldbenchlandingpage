...
export const translations = {
  en: {
    ...
    contact: {
      ...
      securityQuestion: "What is {num1} + {num2}?",
      securityPlaceholder: "Enter your answer",
      captchaError: "Incorrect answer to the security question. Please try again.",
  ...
  de: {
    ...
    contact: {
      ...
      securityLabel: "Sicherheitsüberprüfung",
      securityQuestion: "Was ist {num1} + {num2}?",
      securityPlaceholder: "Antwort eingeben",
      captchaError: "Falsche Antwort auf die Sicherheitsfrage. Bitte versuchen Sie es erneut.",
      sendError: "Senden der Nachricht fehlgeschlagen. Bitte versuchen Sie es erneut.",
    },
  },
  fr: {
    // Hero
    ...
    contact: {
      ...
      securityQuestion: "Combien font {num1} + {num2} ?",
      securityPlaceholder: "Saisissez votre réponse",
      captchaError: "Réponse incorrecte à la question de sécurité. Veuillez réessayer.",
  ...
  it: {
    ...
    contact: {
      ...
      securityQuestion: "Quanto fa {num1} + {num2}?",
      securityPlaceholder: "Inserisci la tua risposta",
      captchaError: "Risposta errata alla domanda di sicurezza. Riprova.",
      sendError: "Invio del messaggio non riuscito. Riprova.",
    },
  },
} as const;
