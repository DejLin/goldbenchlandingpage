    ...
    friction: {
      ...
      points: [
        ...
        },
        {
          ...
          description: "Professionelle, saubere Fotos deiner Stücke zu machen kostet Stunden, die du nicht hast, sodass deine besten Arbeiten auf deinem Handy verborgen bleiben.",
        },
        {
          title: "Verstreute Kundendaten",
          description: "Reparaturen, Ringgrössen und Vorlieben deiner Kunden über Papiernotizbücher und Chat-Apps hinweg zu verwalten, lässt dich unorganisiert wirken.",
        },
      ],
    },
    // Revenue Engine / Features
      ...
      points: [
        {
          ...
          description: "Les prix fluctuants de l'or entraînent des devis lents, et des tableaux obsolètes peuvent rapidement grignoter vos marges durement gagnées.",
        },
        {
          title: "Administration sans fin",
          description: "Rédiger des devis, saisir des reçus et gérer la comptabilité vous vole le temps que vous devriez consacrer à la création de bijoux.",
        },
        {
          title: "Le piège de la photo",
          description: "Obtenir des photos professionnelles et nettes de vos pièces prend des heures que vous n'avez pas, alors vos meilleures œuvres restent cachées sur votre téléphone.",
        },
        {
          title: "Détails clients éparpillés",
          description: "Suivre les réparations, les tailles de bagues et les préférences de vos clients entre carnets papier et applications de messagerie vous fait paraître désorganisé.",
        },
      ],
    },
    // Revenue Engine / Features
      ...
      points: [
        {
          ...
          description: "I prezzi fluttuanti dell'oro significano preventivi lenti, e fogli di calcolo obsoleti possono rapidamente erodere i margini guadagnati con fatica.",
        },
        {
          title: "Amministrazione infinita",
          description: "Scrivere preventivi, registrare ricevute e sistemare la contabilità ruba il tempo che dovresti dedicare a creare gioielli.",
        },
        {
          title: "La trappola delle foto",
          description: "Ottenere foto professionali e pulite dei tuoi pezzi richiede ore che non hai, così i tuoi lavori migliori restano nascosti sul telefono.",
        },
        {
          title: "Dettagli dei clienti sparsi",
          description: "Tenere traccia di riparazioni, misure degli anelli e preferenze dei clienti tra quaderni cartacei e app di chat ti fa sembrare disorganizzato.",
        },
      ],
    },
    // Revenue Engine / Features
